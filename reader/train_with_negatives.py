"""
train 함수와 비슷
그러나 train, validatopm 에 대해 query에 대해 비슷한 문장으로 -- inference와 비슷하게 수정
정답 위치 조정해줘야함
...
def run_mrc(
    ...
    if training_args.do_train:
        ...
        # elastic search에서 추가된 passage를 얻어옵니다.
        train_dataset = datasets["train"]
        es = elastic(INDEX_NAME="wikipedia")
        es.build_elatic()
        train_dataset = es.retrieve_for_train(train_dataset, topk=3)
